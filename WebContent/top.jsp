...
<body>
	...
	<jsp:useBean id="user" scope="session" type="src.dto.UserDTO" />
			...
			<form action="./bbs" method="post">
				<table class="table">
					<tr>
						...
						<td><input class="btn" type="submit" name="shoutbutton"
							value="叫ぶ" /></td>
					</tr>
					<tr>
					...
					<tr>
					<td><input class="btn" type="submit" name="searchbutton"
							value="ユーザー検索" formaction="UserSearchInput.jsp"/></td>
					</tr>
				</table>
			</form>
		</div>
	...
	<jsp:useBean id="shouts" scope="session"
		type="java.util.ArrayList<src.dto.ShoutDTO>" />
	<div class="padding-y-5">
		<div style="width: 40%" class="container padding-y-5">
			<%-- リストにある要素の数だけ繰り返し --%>
				...
				<table class="table table-striped table-bordered">
					...
					<tr>
						<td colspan="2"><input class="form-control" type="text"
							readonly value="${shout.writing}" size="60" /></td>
					</tr>
