		...
		<div style="width: 40%" class="container padding-y-5 text-center">
			...
			<form action="./bbs" method="post">
				<table class="table">
					<tr>
						<%-- 今の気持ち入力欄の名前は shout --%>
						<td><input class="form-control" type="text" name="shout" id="shout"
							value="" size="60" autofocus required/></td><!-- 先頭項目にフォーカス -->
		...
		<div style="width: 40%" class="container padding-y-5">
			...
			<c:forEach var="shout" items="${shouts}">
				<table class="table table-striped table-bordered">
					...
					<tr>
						<td colspan="2"><label class="form-control">${shout.writing}</label><!-- labelに変更 -->
						</td>
					</tr>
				</table>
			</c:forEach>
