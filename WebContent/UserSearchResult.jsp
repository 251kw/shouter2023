			...
			<form action="./uii" method="post" id="checkForm">
				...
				<table class="table" border="1">
					<tr>
						...
						<th class="color-main text-left"><input type="button" onClick="checkAll()" value="全選択"></th>
						<th class="color-main text-left"><input type="button" onClick="checkReset()" value="全解除"></th>
					</tr>
					<tr>
						<th class="color-main text-left">　　</th>
					...
					<td><input class="form-control" type="text" name="name" value="<%--${user.loginId} --%>" size="20" disabled="disabled"/></td>
					<td><input class="form-control" type="text" name="name" value="<%--${user.userName} --%>" size="20" disabled="disabled"/></td>
					<td><span class="<%-- ${user.icon}--%> pe-3x pe-va"></span></td>
					<td><input class="form-control" type="text" name="name" value="<%-- ${user.profile}--%>" size="20" disabled="disabled"/></td>
					</tr>
					<tr>
					<td><input name="test1" type="checkbox"></td>
					<td><input class="form-control" type="text" name="name" value="" size="20" disabled="disabled"/></td>
					<td><input class="form-control" type="text" name="name" value="" size="20" disabled="disabled"/></td>
					<td><input class="form-control" type="text" name="name" value="" size="20" disabled="disabled"/></td>
					<td><input class="form-control" type="text" name="name" value="" size="20" disabled="disabled"/></td>
					</tr>
					...
					<tr>
						<td colspan="2" class="text-right"><input class="btn"
							type="submit" value="削除" /> <a href="UserSearchInput.jsp" class="btn">戻る</a>
						</td>
					</tr>
				</table>
			</form>
