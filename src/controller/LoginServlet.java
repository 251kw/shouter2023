...
public class LoginServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String login = request.getParameter("login");//loginボタンが押された時のvalueをゲット
		String register = request.getParameter("register");//登録画面ボタンが押された時のvalueをゲット

		RequestDispatcher dispatcher = null;
		String message = null;

		if (login != null) {//loginボタンが押された時の処理
